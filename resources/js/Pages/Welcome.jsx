    ...
    return (
        <>
            ...
            <Header auth={auth} />
                ...
                {/* Hero Section */}
                <main
                    className="relative bg-gray-100 min-h-screen flex items-center justify-center bg-cover bg-center"
...
<section id='behandelingen' className="container mx-auto py-8 px-4 md:px-8">
