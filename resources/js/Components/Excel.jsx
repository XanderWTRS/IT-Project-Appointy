      ...
      {showExcelImage && (
        <Modal>
          <div className="modal-content">
            ...
            <p className="my-4"><strong>Dit is hoe het excel bestand eruit moet zien!<br></br><span className="text-red-500 text-lg">*De kolommen "password", "keuze_sms", "keuze_email", "betaald" mogen leeg zijn!</span></strong></p>
            <button
              onClick={() => {
